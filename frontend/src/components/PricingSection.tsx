    ...
    <section id="pricing" className="py-24 bg-muted/20">
      <div className="container mx-auto px-4">
        <motion.div
          ...
          viewport={{ once: true }}
          className="text-center mb-10 tab:mb-16"
        >
        ...
        {/* Top-up packs */}
        <div className="flex tab:grid tab:grid-cols-3 gap-5 max-w-4xl mx-auto mb-16 overflow-x-auto scroll-x scrollbar-hide px-4 -mx-4 tab:px-0 tab:mx-auto">
          {TOPUP_PACKS.map((pack, i) => (
            <motion.div
              ...
              className="glass-card rounded-2xl p-6 relative flex flex-col min-w-[280px] tab:min-w-0 snap-start"
            >
              {pack.badge && (
        ...
        <div className="flex tab:grid tab:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto overflow-x-auto scroll-x scrollbar-hide px-4 -mx-4 tab:px-0 tab:mx-auto">
          {SUBSCRIPTION_PLANS.map((plan, i) => {
            ...
            return (
              <motion.div
                ...
                className={`glass-card rounded-2xl p-6 relative flex flex-col min-w-[280px] tab:min-w-0 snap-start ${plan.popular ? "border-primary/50 ring-1 ring-primary/20" : ""}`}
              >
                {plan.popular && (
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm">
            <div>
              ...
              <p className="text-foreground font-bold text-lg">$29/month</p>
            </div>
          ...
          <p className="text-small text-muted-foreground mt-4 font-medium px-4 py-1.5 rounded-full bg-primary/5 inline-block">
            3x more value, pay 70% less
          </p>
        </motion.div>
      </div>
    </section>
