    ...
    <div className="p-1">
      ...
      {tab === "signup" && (
        <div className="flex items-center gap-2 mb-5 px-3 py-2 rounded-lg bg-secondary/10 border border-secondary/20">
          ...
          <span className="text-xs text-secondary font-medium">You'll get 5 free credits instantly</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" variant="hero" className="w-full h-12 font-bold" disabled={loading}>
      ...
      <Button variant="heroGhost" className="w-full h-12 font-medium" onClick={handleGoogle}>
