...
const ROW_1_THUMBNAILS = [
  ...
  },
  {
    ...
    ctr: "+54% CTR",
    tag: "MrBeast Studios",
    image: "/thumb-mrbeast-hotel.jpg",
    textHook: "$1 VS $1,000,000",
    category: "Luxury",
  },
  {
    title: "IShowSpeed Explores India (Live Stream IRL)",
    views: "12.4M views",
    ctr: "+51% CTR",
    tag: "IShowSpeed IRL",
    image: "/thumb-speed-real.jpg",
    textHook: "BEST MOMENTS!",
    category: "Sports IRL",
  },
  {
    ...
    ctr: "+46% CTR",
    tag: "Airrack Studio",
    image: "/thumb-airrack.jpg",
    textHook: "DAY 6 LOCKED UP!",
    category: "Survival",
  },
  {
    title: "Tinder In Real Life (Viral Dating Challenge)",
    views: "28.5M views",
    ctr: "+49% CTR",
    tag: "CarryMinati",
    image: "/thumb-carryminati.jpg",
    textHook: "TINDER IRL!",
...
const ROW_2_THUMBNAILS = [
  {
    title: "Cristiano Ronaldo Meets MrBeast (UR · Cristiano)",
    views: "45.0M views",
    ctr: "+58% CTR",
    tag: "Ronaldo x MrBeast",
    image: "/thumb-ronaldo-mrbeast.jpg",
    textHook: "MEET MRBEAST!",
    category: "Legends",
  },
  {
    title: "$1 vs $500,000 Airplane Ticket!",
    views: "52.1M views",
    ctr: "+56% CTR",
    tag: "MrBeast Mega",
    image: "/thumb-mrbeast-plane.jpg",
    textHook: "$1 VS $500K TICKET",
    category: "Challenge",
  },
  {
    title: "I Survived On 1 Penny Across America",
    views: "18.3M views",
    ctr: "+47% CTR",
    tag: "Ryan Trahan",
    image: "/thumb-ryan-trahan.jpg",
    textHook: "1 PENNY CHALLENGE",
    category: "Adventure",
  },
  {
    title: "Celine Dept vs 6'11 Giant Goalkeeper Challenge",
    views: "11.2M views",
    ctr: "+44% CTR",
    tag: "Celine Dept",
    image: "/thumb-celine-dept.jpg",
    textHook: "6'11 GOALKEEPER!",
    category: "Football",
  },
  {
    ...
    ctr: "+52% CTR",
    tag: "MrBeast Challenge",
    image: "/thumb-mrbeast-circle.jpg",
    textHook: "DAY 97 TORNADO!",
    category: "Extreme",
  },
];
