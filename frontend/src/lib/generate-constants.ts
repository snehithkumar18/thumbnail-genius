export const STYLE_PRESETS = [
  { id: "realistic", label: "Realistic", emoji: "📷", image: "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?w=200&h=120&fit=crop" },
  { id: "cinematic", label: "Cinematic", emoji: "🎬", image: "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=200&h=120&fit=crop" },
  { id: "bold graphic", label: "Bold Graphic", emoji: "🎨", image: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?w=200&h=120&fit=crop" },
  { id: "dark dramatic", label: "Dark Dramatic", emoji: "🌑", image: "https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=200&h=120&fit=crop" },
  { id: "minimal", label: "Minimal", emoji: "✨", image: "https://images.unsplash.com/photo-1494438639946-1ebd1d20bf85?w=200&h=120&fit=crop" },
  { id: "anime", label: "Anime", emoji: "🎌", image: "https://images.unsplash.com/photo-1578632738981-067dc45339d6?w=200&h=120&fit=crop" },
  { id: "neon glow", label: "Neon Glow", emoji: "💡", image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=200&h=120&fit=crop" },
  { id: "retro", label: "Retro", emoji: "📼", image: "https://images.unsplash.com/photo-1520333789090-1afc82db536a?w=200&h=120&fit=crop" },
  { id: "luxury", label: "Luxury", emoji: "💎", image: "https://images.unsplash.com/photo-1413806151480-bd60cd1919ba?w=200&h=120&fit=crop" },
] as const;
...
export const CTR_TIPS = [
  "Thumbnails with faces get 38% more clicks.",
  "Blue and red color schemes have the highest CTR on YouTube.",
  "Keep text under 4 words for maximum impact on mobile.",
  "High contrast between the subject and background is key.",
  "Arrows and circles can guide the viewer's eye to the 'hook'.",
  "Consistency in your branding helps viewers recognize your content.",
];
