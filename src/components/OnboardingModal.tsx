    ...
    switch (step) {
        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-heading font-bold text-foreground mb-2">Welcome to ThumbAI! 🎉</h2>
              <p className="text-muted-foreground">What kind of YouTube content do you make?</p>
              <p className="text-xs text-muted-foreground mt-1">Select 1–3 categories</p>
            </div>
            ...
            <Button onClick={saveCategory} disabled={selectedCategories.length === 0} className="w-full" size="lg">
      ...
      case 2:
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-heading font-bold text-foreground mb-2">Upload Your Face</h2>
              <p className="text-muted-foreground">For Face Swap thumbnails (optional)</p>
            </div>
            ...
            <div className="flex gap-3">
              <Button onClick={saveFace} className="flex-1" size="lg">
                {faceFile ? "Save My Face" : "Skip for now"}
              </Button>
            </div>
            <button onClick={() => setStep(3)} className="text-xs text-muted-foreground hover:text-foreground mx-auto block">
              Skip for now →
            </button>
          </div>
        );
      case 3:
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-heading font-bold text-foreground mb-2">Brand Colors</h2>
              <p className="text-muted-foreground">Set your channel's brand colors (optional)</p>
            </div>
            ...
            <div className="flex items-center justify-center gap-2">
              <div className="w-40 h-24 rounded-xl border border-border overflow-hidden" style={{ background: `linear-gradient(135deg, ${primaryColor}, ${secondaryColor})` }}>
                <div className="w-full h-full flex items-center justify-center text-white font-heading font-bold text-sm drop-shadow-lg">
                  Preview
                </div>
              </div>
            </div>
            <Button onClick={saveColors} className="w-full" size="lg">
              Next <ChevronRight className="h-4 w-4 ml-1" />
            </Button>
            <button onClick={() => setStep(4)} className="text-xs text-muted-foreground hover:text-foreground mx-auto block">
              Skip →
            </button>
          </div>
        );
      case 4:
        return (
          <div className="space-y-6">
            ...
            {!generatedImage && (
              <button onClick={finishOnboarding} className="text-xs text-muted-foreground hover:text-foreground mx-auto block">
