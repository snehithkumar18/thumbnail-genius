      ...
      <div className="lg:w-[40%] shrink-0 overflow-y-auto space-y-5 pr-2">
        ...
        <div>
          ...
          <div className="space-y-2">
            {([
              { id: "fast" as const, icon: Zap, label: "Fast", model: "Schnell", credits: 1, time: "~5s" },
              { id: "pro" as const, icon: Star, label: "Pro", model: "Ultra", credits: 2, time: "~15s" },
            ]).map((q) => (
              <button
                key={q.id}
              ...
              >
                ...
                <div className="text-left flex-1">
                  ...
                  <span className="text-muted-foreground text-xs ml-2">{q.model} — {q.credits} credit — {q.time}</span>
                </div>
              </button>
            ))}
          </div>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1.5">
            Total cost: <span className="text-foreground font-semibold">{creditCost} credits</span>
          </p>
        </div>
        ...
        >
          {generating ? (
            ...
            <>Generate Thumbnail ({creditCost} credits)</>
          )}
        </Button>
        ...
        {generating ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <div className="w-full max-w-xs space-y-3">
              ...
              <Button variant="ghostNav" size="sm" className="w-full" onClick={handleCancel}>
                Cancel
              </Button>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-center gap-2 flex-wrap mb-4">
              ...
              <Button variant="outline" size="sm" className="border-border">
                <Pencil className="h-3.5 w-3.5 mr-1.5" /> Edit with AI
              </Button>
              <Button variant="outline" size="sm" className="border-border">
